...
enum EPlayerType
{
	PLAYER_TYPE_NONE = 0,
	PLAYER_TYPE_CAR = 1,
	PLAYER_TYPE_PEDESTRIAN = 2,
	PLAYER_TYPE_NULL = 3
};

enum ECivAIControlState
{
	CIV_AI_CTRL_DRIVE = 0,
	CIV_AI_CTRL_WAIT_TRAFFIC_LIGHT = 1,

	CIV_AI_CTRL_YIELD_TURN = 4,		// thrust 5
	CIV_AI_CTRL_PARKED = 5,
	CIV_AI_CTRL_YIELD_STRAIGHT = 6,
	CIV_AI_CTRL_EMPTY = 7,
	CIV_AI_CTRL_STOP_AT_NODE = 8,	// or PARK_AT_NODE?
	CIV_AI_CTRL_DIED_WITH_MUSIC = 9,
};

enum ECivAIThrustState
{
	CIV_AI_THRUST_ACCELERATE = 0,
	CIV_AI_THRUST_STOP_AT_NODE = 1,
	CIV_AI_THRUST_STOP = 3,
	CIV_AI_THRUST_YIELD = 6,
};

// combatd2enginesnd.c — Combat D2: the engine rev + idle channel tuner.
//
...
// pitch and volume (CD2_SND_* in combatd2.h), and JER_EVENT_CAR_REVS scales how
...
void cd2EngineSndRegister(JERICHO_CONTEXT* ctx)
{
	...
	ctx->jer_log(ctx, "[combatd2] engine sound registered (SDK v%d)\n", ctx->sdkVersion);
}

// combatd2sim.c — Combat D2: the point-mass handling model.
//
...
// wreck/explosion never fire while the pause menu is up. See combatd2menu.c.
...
// Roll-over suppression. Runs at CAR_STEP (after combatd2wreckfx's wreck toss,

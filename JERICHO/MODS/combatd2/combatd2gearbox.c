// combatd2gearbox.c — Combat D2: the engine gearbox tuner.
//
// (Split out of the old combatd2media.c; see combatd2_internal.h for the file
// map.)
//
...
// levels the pitch at the car's combatd2 top speed - revs never wind past
// CD2_REV_CEILING even as the point-mass speed keeps climbing. Tuners are the
// CD2_GEAR_* macros in combatd2.h.
...
void cd2GearboxRegister(JERICHO_CONTEXT* ctx)
{
	...
	ctx->jer_log(ctx, "[combatd2] gearbox registered (SDK v%d)\n", ctx->sdkVersion);
}

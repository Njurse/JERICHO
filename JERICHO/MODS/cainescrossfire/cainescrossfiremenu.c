// cainescrossfiremenu.c — Combat D2: the pause menu.
//
...
static int cd2TotalCar(void* ud, int dir)
{
	...
	// defer: cainescrossfiresim.c applies it on the next physics frame (after
...
// registration so cainescrossfire.c does not need to see cd2Menu).
// ---------------------------------------------------------------------------

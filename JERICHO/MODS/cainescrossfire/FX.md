# Caine's Crossfire — Explosions & weapon FX

Every weapon impact in Caine's Crossfire goes through a small **parametric explosion
...
anything around it (`cainescrossfirewreckfx.c`).

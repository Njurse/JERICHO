#!/usr/bin/env bash
# arena_test.sh - self-terminating smoke test for the cainescrossfire mod.
#
...
# cainescrossfire fields NO opponents unless a match asks for them (ai_opponents, default
# 0), and a run with nobody to fight tests far less. Ask here. Override to taste:
#   CC_OPPONENTS=0 ./arena_test.sh 900    # the quiet world, no AI at all
#   CC_OPPONENTS=2 ./arena_test.sh 900    # a two-opponent match
: "${CC_OPPONENTS:=4}"
export CC_OPPONENTS

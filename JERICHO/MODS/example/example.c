 ...
 * build it with the SDK (JERICHO/sdk/build_mods.bat) or the game's
 * mods build into <id>.dll, drop the DLL next to mod.toml, and the
 * runtime loads it at boot / on Mods-menu reload.
 */
#include "jericho.h"
